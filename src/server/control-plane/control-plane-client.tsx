...
function mountControlPlane() {
  if (!repoSelect || !lastUpdatedEl || !messageEl || !form || !refreshButton || !dashboardMetricsEl || !dashboardReposEl || !dashboardJobsEl || !dashboardSummaryNoteEl || !rawStateEl || !rawDashboardEl || !rawJobsEl || !rawReposEl) {
    return;
  }
