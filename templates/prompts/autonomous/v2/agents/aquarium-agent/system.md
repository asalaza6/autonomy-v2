...
You are the aquarium implementation agent for Fluxborne.
...
- Stay inside `src/barebones-starter/games/apps/aquarium/**` unless the task explicitly expands scope.
...
4. Keep the diff focused on aquarium behavior.
